...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Underline'
        db.create_table('social_underline', (
        ...
        db.send_create_signal('social', ['Underline'])


    def backwards(self, orm):
        
        # Deleting model 'Underline'
        db.delete_table('social_underline')
